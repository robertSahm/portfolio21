		...
		<div className="frame">
			...
			<div className="column copy-column">
				<p className="body-copy">
					...
					needed a solution to host and serve their own videos while adhering to a strict design aesthetic. My
					responsibilities included implementing static concept art into animated, interactive satisfaction
					using JS, HTML, SCSS and Ruby.
				</p>
			</div>
